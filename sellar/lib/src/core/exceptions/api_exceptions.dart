...
class ValidationException extends ApiException {
  ...
  const ValidationException(String message, [this.fieldErrors]) : super(message, 400);
...
class UnexpectedResponseException extends ApiException {
  const UnexpectedResponseException(String message, [int? statusCode]) : super(message, statusCode);
}
